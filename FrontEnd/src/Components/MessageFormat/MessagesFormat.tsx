...
const MessagesFormat = () => {
  ...
  const onChange = (e:React.ChangeEvent<HTMLTextAreaElement | HTMLInputElement>)=>{
    setMessageForm((prev=>({
      ...prev,
      [e.target.name]: e.target.value[0].toUpperCase() + e.target.value.slice(1).toLowerCase(),
    })))
  }
  ...
  return (
    <Grid2 onSubmit={onSubmit} container  spacing={2} component="form">
        ...
        <Button disabled={postMessageLoading} variant="contained" color="primary" type="submit" sx={{marginLeft:"auto"}}>
